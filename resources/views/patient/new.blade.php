...
<div class="uk-padding-small">
    <form action="{{ route('save-patient') }}" method="POST">
        ...
        <div class="uk-flex uk-child-width-1-3@m uk-child-width-1-1@s" uk-grid uk-height-match>
            <div class="uk-card uk-card-body">
                <h2>Patient's Biodata</h2>
                <span class="uk-text-right">Reg Num: {{$regNum}}</span>
                <div class="uk-margin">
            ...
            <div class="uk-card uk-card-body uk-form-horizontal">
                <h2>Medication</h2>
                <div class="uk-margin">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls uk-child-width-1-2 uk-grid-small" uk-grid>
        ...
        <hr>
        <div class="uk-flex uk-child-width-1-3@m uk-child-width-1-1@s uk-form-horizontal" uk-grid uk-height-match>
            <div class="uk-card uk-card-body">
            ...
            <div class="uk-card uk-card-body">
                <h2>Ecocardiograph</h2>
                <div class="uk-margin">
                    <label class="uk-form-label">EFb</label>
                    <div class="uk-form-controls">
                        <input type="text" id="ef" name="ef" class="uk-input uk-margin-small" value="" placeholder="%">
                    </div>
                </div>
                <div class="uk-margin">
                    <label class="uk-form-label">TAPSE</label>
                    <div class="uk-form-controls">
                        <input type="text" id="tapse" name="tapse" class="uk-input uk-margin-small" value="" placeholder="cm">
                    </div>
                </div>
                <div class="uk-margin uk-grid-large uk-child-width-1-2 uk-column"> 
                    <label class="uk-margin-small"><input class="uk-checkbox" type="checkbox" name="mr"> MR (medium-weight)</label>
                    <label class="uk-margin-small"><input class="uk-checkbox" type="checkbox" name="as"> AS (medium-weight)</label>
                </div>
